...
function buildPrompt({ article, prompt, context, source }) {
  ...
  return [
    ...
    "Make the overlay copy sound like a human editor understood the story, not like keywords were pasted together.",
    "Prefer a clear cause-and-effect or contrast when the source supports it, for example why something feels different, why a person matters, or what changed.",
    "For reviews, commentary, social posts, videos, and entertainment stories, identify the central person/show/event and the specific reason people care.",
    ...
    "Avoid generic headlines that could fit any article; every headline must contain the specific subject and the specific point.",
